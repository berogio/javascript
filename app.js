...
//როგორ შევქნათ და გამოვიძახოთ ანომიმური ფუნქცია
(function() {
    console.log(`გამარჯობა`)
})();
//ამისათვის ფუნქციას მთლიან ფუნქციას ვსვავთ ()_ში და ბოლოში ვიძახებთ  შემდეგნაირად ();

//არსებობს მეორე ვარიანტი ანონიმური ფუნქციის შექმნის და გამოძახების მაგალითად:
// ამისათვის ფუნქციას ვსვავთ ცვლადში და ვიძახებთ ცვლადს
...
console.log(summ(10));
// არგუმენტ a_ს გადავეცით პარამეტრი 10
// კონსულში დაილოგება 20
// return ქვემოთ აღარ სრულდება არაფერი ამიტომ გაგვიუფერულა ედიტორმა


// arrow ფუნქცია    ვქმნით ცვლადს  (ფუნცქიის სახელი გადმოვიტანეთ ცვლადის სახელში წინა ფუნქციიდან) შევქმენით a პარამეტრი
const summ = a => {
    return a + 10;
}
console.log(summ(a)); // a__ს ვაძლევთ პარამეტრებს მაგალითად 20, 30 ,40
// იგივე ჩანაწერია return_ის გარეშე 
const summ = a => a + 10;

// თუ გვსურს პარამეტრის გარეშე მაშინ  კონსულ ლოგში ვწერთ უბრალოდ ()
const summ = () => 10 + 10;
console.log(summ());
// დაგვიბრუნებს 20;
// შეკრება 
...
console.log(Boolean(1 > 2));
//კონსულში გამოგივიტანს false
//ნებისმიერი ცვლადი რომელსაც არ ექნება მნიშვნელობა გამოგვიტანს false მაგალითად
let x;
console.log(Boolean(x)));
//გამოგვიტანს false
//თუ აქვს რაიმე ველიუ მაგალითად: გარდა 0 ის (თუ სთრინგი არაა `0`) და გარდა მნიშვნელობისა undefined
let x = `giorgi`
console.log(Boolean(x));
//დაგვიბრუნებს tru
...
if (wlovaneba[2] == 17) {
    console.log(`ეს სწორია`)
} else {
    console.log(`ეს არასწორია`)
}
//კონსულში დაიბეჭდება `ეს სწორია`
// თუ პირობა არ სრულდება ანუ else დაიბეჭდება ეს არასწორია